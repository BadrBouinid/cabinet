...
public class AjouterNouveauPatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTel, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 210, 205, -1));
        ...
        getContentPane().add(jAdresse, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 290, 205, -1));
        ...
        getContentPane().add(jSex, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 250, 205, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 330, 140, -1));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, 290, 70));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Hopital/images/waves.jpg"))); // NOI18N
        jLabel9.setText("jLabel9");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-6, 0, 580, 390));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Statement stm=con.createStatement();
             ResultSet rs= stm.executeQuery("select * from patient where cin='"+cin+"'");
        ...
        else if(jCin.getText().length()>8||jTel.getText().length()>10){
          JOptionPane.showMessageDialog(null, "Entrez un format correcte");
        }
       else if (rs.next()) {
        JOptionPane.showMessageDialog(null, "Cette personne est déja existe");
        
            }
               else{
            stm.executeUpdate("insert into patient(cin,nom,prenom,telephone,sex,adresse)values('"+cin+"','"+nom+"','"+prenom+"','"+tel+"','"+sex+"','"+adresse+"')");
